...
insert  into `customermaster`(`CustomerId`,`CustomerName`,`PhoneNumber`,`Address`,`Location`,`email`,`Gender`) values ('C2','srinivas','9999999999','Ameerpet','Hyderabad','kalyan@gmail.com','Male'),('C3','Raj','9909909900','Dilshuknagar','Hyderabad','Raj001@yahoo.com','Male'),('C4','Rani','9440944000','Ranigunz','Hyderabad','Rani07@gmail.com','Female'),('C5','Rahul','9999999999','Bangalore','Hyderabad','RahulM@rediff.com','Male'),('C6','Suresh','9999999990','Gachibowli','Hyderabad','Suresh@zapakmail.com','Male');
...
insert  into `travelsmaster`(`TravelsId`,`Travels`,`Location`,`Address`,`AgentName`,`PhoneNumber`) values ('T2','Raj Travels','Bangalore','Koramangala,Bangalore','Srinivas','9290000000'),('T3','Pran Travels','Hyderabad','Lower Tankbund','Pravan','9898000000'),('T1','kesineni','Hyderabad','ameerpet, hyd','kesi reddy','9800000000'),('T4','sai','Hyderabad','ap, hyd','sai','9000000000');
